<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/128573786/12.1.4%2B)
...
* [Form1.cs](./CS/Series_SideBySideGanttChart/Form1.cs) (VB: [Form1.vb](./VB/Series_SideBySideGanttChart/Form1.vb))
<!-- default file list end -->
# How to create a Side-by-Side Gantt chart


<p>The following example demonstrates how to create a <a href="http://devexpress.com/Help/Content.aspx?help=XtraCharts&document=CustomDocument2984.htm">Side-By-Side Gantt</a> chart at runtime.</p>
