...
Namespace Series_SideBySideGanttChart
	Partial Public Class Form1
		...
		Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
			...
			' Add points to them.
			series1.Points.Add(New SeriesPoint("Task 1", New DateTime() { New DateTime(2006, 8, 16), New DateTime(2006, 8, 31) }))
			series1.Points.Add(New SeriesPoint("Task 2", New DateTime() { New DateTime(2006, 8, 31), New DateTime(2006, 9, 15) }))
			series1.Points.Add(New SeriesPoint("Task 3", New DateTime() { New DateTime(2006, 9, 15), New DateTime(2006, 9, 30) }))
			series1.Points.Add(New SeriesPoint("Task 4", New DateTime() { New DateTime(2006, 9, 30), New DateTime(2006, 10, 15) }))

			series2.Points.Add(New SeriesPoint("Task 1", New DateTime() { New DateTime(2006, 8, 16), New DateTime(2006, 9, 5) }))
			series2.Points.Add(New SeriesPoint("Task 2", New DateTime() { New DateTime(2006, 9, 5), New DateTime(2006, 9, 22) }))
			series2.Points.Add(New SeriesPoint("Task 3", New DateTime() { New DateTime(2006, 9, 22), New DateTime(2006, 10, 10) }))
			series2.Points.Add(New SeriesPoint("Task 4", New DateTime() { New DateTime(2006, 10, 10), New DateTime(2006, 10, 23) }))
